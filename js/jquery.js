...
!function (a, b) {
  ...
  n.extend = n.fn.extend = function () {
    ...
    c = e[d],
    g !== c && (j && c && (n.isPlainObject(c) || (b = n.isArray(c))) ? (b ? (b = !1, f = a && n.isArray(a) ? a : [
           ...
           : function (b, c, i) {
            ...
            if (q) {
              ...
              if (o = [
               ...
               else while (l = ++n && l && l[p] || (m = n = 0) || o.pop()) if ((h ? l.nodeName.toLowerCase() === r : 1 === l.nodeType) && ++m && (t && ((l[s] || (l[s] = {
              })) [a] = [
                u,
                m
              ]), l === b)) break;
      ...
      return b.first ? function (b, c, f) {
       ...
       : function (b, c, g) {
        ...
        if (g) {
          ...
          if (i = b[s] || (b[s] = {
          }), (h = i[d]) && h[0] === u && h[1] === f) return j[2] = h[2];
  ...
  B = n.fn.init = function (a, b) {
    ...
    if ('string' == typeof a) {
      if (c = '<' === a.charAt(0) && '>' === a.charAt(a.length - 1) && a.length >= 3 ? [
        ...
        a,
        null
      ] : A.exec(a), !c || !c[1] && b) return !b || b.jquery ? (b || y) .find(a)  : this.constructor(b) .find(a);
      if (c[1]) {
  ...
  n.extend({
    ...
    ready: function (a) {
      if (a === !0 ? !--n.readyWait : !n.isReady) {
        ...
        n.isReady = !0,
        a !== !0 && --n.readyWait > 0 || (I.resolveWith(z, [
          n
    ...
    if (n.acceptData(a)) {
      ...
      if (g[h]) {
        if (b && (d = c ? g[h] : g[h].data)) {
          n.isArray(b) ? b = b.concat(n.map(b, n.camelCase))  : b in d ? b = [
            b
  ...
  n.event = {
    ...
    add: function (a, b, c, d, e) {
      ...
      if (r) {
        ...
        ], m.delegateCount = 0, j.setup && j.setup.call(a, d, p, k) !== !1 || (a.addEventListener ? a.addEventListener(o, k, !1)  : a.attachEvent && a.attachEvent('on' + o, k))), j.add && (j.add.call(a, l), l.handler.guid || (l.handler.guid = c.guid)), e ? m.splice(m.delegateCount++, 0, l)  : m.push(l), n.event.global[o] = !0);
        a = null
      }
    },
    ...
    trigger: function (b, c, d, e) {
      ...
      if (h = l = d = d || z, 3 !== d.nodeType && 8 !== d.nodeType && !_.test(p + n.event.triggered) && (p.indexOf('.') >= 0 && (q = p.split('.'), p = q.shift(), q.sort()), g = p.indexOf(':') < 0 && 'on' + p, b = b[n.expando] ? b : new n.Event(p, 'object' == typeof b && b), b.isTrigger = e ? 2 : 3, b.namespace = q.join('.'), b.namespace_re = b.namespace ? new RegExp('(^|\\.)' + q.join('\\.(?:.*\\.|)') + '(\\.|$)')  : null, b.result = void 0, b.target || (b.target = d), c = null == c ? [
        b
      ] : n.makeArray(c, [
        b
      ]), k = n.event.special[p] || {
    ...
    handlers: function (a, b) {
      ...
      if (h && i.nodeType && (!a.button || 'click' !== a.type)) for (; i != this; i = i.parentNode || this) if (1 === i.nodeType && (i.disabled !== !0 || 'click' !== a.type)) {
        ...
        c = d.selector + ' ',
        void 0 === e[c] && (e[c] = d.needsContext ? n(c, this) .index(i) >= 0 : n.find(c, this, null, [
          i
        ]) .length),
        e[c] && e.push(d);
        e.length && g.push({
  ...
  function vb(a, b) {
    ...
    if (!f) for (f = [
    ], c = a.childNodes || a; null != (d = c[e]); e++) !b || n.nodeName(d, b) ? f.push(d)  : n.merge(f, vb(d, b));
  ...
  n.extend({
    ...
    buildFragment: function (a, b, c, d) {
      for (var e, f, g, h, i, j, k, m = a.length, o = eb(b), p = [
      ], q = 0; m > q; q++) if (f = a[q], f || 0 === f) if ('object' === n.type(f)) n.merge(p, f.nodeType ? [
        f
      ] : f);
       else if (mb.test(f)) {
  ...
  n.each({
    ...
    n.fn[a] = function (a) {
      for (var c, d = 0, e = [
      ], g = n(a), h = g.length - 1; h >= d; d++) c = d === h ? this : this.clone(!0),
      n(g[d]) [b](c),
      f.apply(e, c.get());
  ...
  n.offset = {
    setOffset: function (a, b, c) {
      ...
      f = n.css(a, 'top'),
      i = n.css(a, 'left'),
      j = ('absolute' === k || 'fixed' === k) && n.inArray('auto', [
        f,
        i
      ]) > - 1,
